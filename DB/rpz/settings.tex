...
\usepackage{caption} % Подключаем пакет caption
\usepackage{array} % Если он еще не подключен
\usepackage{amsmath}
\usepackage{geometry}
\geometry{left=30mm}
\geometry{right=10mm}
...
\usepackage{tabularx}
\usepackage{ctable}
\captionsetup[table]{justification=raggedright,singlelinecheck=off, position=top}
